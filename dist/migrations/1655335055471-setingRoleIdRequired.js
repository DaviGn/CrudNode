...
class setingRoleIdRequired1655335055471 {
    constructor() {
        this.name = 'setingRoleIdRequired1655335055471';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_fda64da5f551e18c5e7d7bbde7c"`);
            yield queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "roleid" SET NOT NULL`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_fda64da5f551e18c5e7d7bbde7c"`);
            yield queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "roleid" DROP NOT NULL`);
            yield queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_fda64da5f551e18c5e7d7bbde7c" FOREIGN KEY ("roleid") REFERENCES "roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        });
    }
}
